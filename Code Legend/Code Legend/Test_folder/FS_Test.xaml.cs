...
{
    public string[] questions = { "What Label can be?", "What is Button defines?", "When the Clicked event raised?", "What is Image defines?" , "What StackLayout is used for?", "What views does HorizontalStackLayout organize?", "To position Grid cells is using?" };
